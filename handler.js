                    ...
                    for (let user of participants) {
                       let pp = 'https://telegra.ph/file/ddd756ee15579bdfba651.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome To Grup @user').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
